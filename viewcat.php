...
$title = $ltitle;
	...
	$xoopsTpl->append('games', array('id' => $lid, 'cid' => $cid,  'rating' => number_format($rating, 2), 'title' => $title, 'ext' => $new.$pop, 'category' => $path, 'logourl' => $myts->makeTboxData4Show($logourl), 'updated' =>
 formatTimestamp($time,"s"), 'description' => $myts->makeTareaData4Show($description), 'adminlink' => $adminlink, 'hits' => $hits, 'votes' => $votestring, 'comments' => $comments, 'members' => $members, 'image' => $img ));
    } 
